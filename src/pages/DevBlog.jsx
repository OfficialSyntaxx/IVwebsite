                ...
                {BLOG_POSTS.map((post) => (
                    ...
                    >
                        ...
                        <div className="h-48 bg-slate-950 relative flex items-center justify-center overflow-hidden">
                            ...
                            <post.icon size={64} className="text-slate-700 group-hover:text-cyan-500/50 transition-colors duration-500 transform group-hover:scale-110" />
                            <div className="absolute top-4 left-4 bg-black/60 backdrop-blur px-3 py-1 rounded text-xs font-bold uppercase tracking-wider text-cyan-400 border border-cyan-500/20">
                                {post.tag}
                            </div>
                        </div>
